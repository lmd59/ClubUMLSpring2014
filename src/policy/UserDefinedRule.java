...
public class UserDefinedRule
{
	...
	public void setMustNotHaveIncludeAssociation(
			IncludeAssociation mustHaveIncludeAssociation) {
		this.mustHaveIncludeAssociation = mustHaveIncludeAssociation;
	}
	
	public void setMustNotHaveExtendAssociation(ExtendAssociation mustMustNotHaveExtendAssociation)
	{
		this.mustHaveExtendAssociation =  mustMustNotHaveExtendAssociation;
	}
	
	public ExtendAssociation getMustNotHaveExtendAssociation() {
